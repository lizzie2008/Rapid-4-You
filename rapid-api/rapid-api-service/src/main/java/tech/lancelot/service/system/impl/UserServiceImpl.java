...
import tech.lancelot.dto.system.JobSmallDto;
import tech.lancelot.dto.system.RoleSmallDto;
import tech.lancelot.dto.system.UserDto;
import tech.lancelot.dto.system.UserQueryCriteria;
import tech.lancelot.exceptions.EntityExistException;
import tech.lancelot.exceptions.EntityNotFoundException;
import tech.lancelot.mapstruct.sys.UserMapper;
import tech.lancelot.properties.FileProperties;
import tech.lancelot.repository.system.UserRepository;
import tech.lancelot.service.system.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public Object queryAll(UserQueryCriteria criteria, Pageable pageable) {
        Page<User> page = userRepository.findAll((root, criteriaQuery, criteriaBuilder) -> QueryHelp.getPredicate(root, criteriaQuery, criteriaBuilder, criteria), pageable);
        return PageUtil.toPage(page.map(userMapper::toDto));
    }

    @Override
    public List<UserDto> queryAll(UserQueryCriteria criteria) {
        List<User> users = userRepository.findAll((root, criteriaQuery, criteriaBuilder) -> QueryHelp.getPredicate(root, criteriaQuery, criteriaBuilder, criteria));

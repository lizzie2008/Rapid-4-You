...
import tech.lancelot.repository.system.MenuRepository;
...
import tech.lancelot.vo.MenuMetaVo;
import tech.lancelot.vo.MenuVo;
...
//    @Cacheable(key = "'user:' + #p0")
    ...
    public void update(Menu resources) {
        ...
        menu.setAffix(resources.getAffix());
        menu.setBreadcrumb(resources.getBreadcrumb());
    ...
    public List<MenuVo> buildMenus(List<MenuDto> menuDtos) {
        ...
        menuDtos.forEach(menuDTO -> {
                    if (menuDTO != null) {
                        ...
                        menuVo.setRedirect(menuDTO.getRedirect());
                        // 如果不是外链

...
import tech.lancelot.mapstruct.sys.DeptMapper;
import tech.lancelot.repository.system.DeptRepository;
...
public class DeptServiceImpl implements DeptService {
    ...
    public List<DeptDto> queryAll(DeptQueryCriteria criteria, Boolean isQuery) throws Exception {
        ...
        List<DeptDto> list = deptMapper.toDto(deptRepository.findAll((root, criteriaQuery, criteriaBuilder) -> QueryHelp.getPredicate(root, criteriaQuery, criteriaBuilder, criteria), sort));
